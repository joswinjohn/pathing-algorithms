...
export default function Home() {
  ...
  let [endVert, setEndVert] = useState<number>(0);
  ...
  const updateEndVert = (value: number) => {
    setEndVert(value);
  };
      ...
      <main className="flex flex-col row-start-2 items-center sm:items-start">
        ...
        <div className="grid grid-cols-[60%_40%] items-center justify-items-center flex-col sm:flex-row">
          ...
          <div className="flex flex-col">
            ...
            />
            <input 
              className="block p-2 mb-2 text-sm font-medium text-gray-900 bg-white border border-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Ending Vertex..."
              onChange={(e) =>
                updateEndVert(Number(e.target.value))}
            />
            <button
